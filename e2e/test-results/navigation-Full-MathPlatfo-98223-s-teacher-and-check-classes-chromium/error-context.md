...
- Name: navigation.spec.ts >> Full MathPlatform Navigation >> login as teacher and check classes
- Location: navigation.spec.ts:34:7
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e6]:
      - generic [ref=e7]:
        ...
        - textbox [ref=e9]: profesor@test.com
      - generic [ref=e10]:
