                ...
                "units": [
                    {
                        ...
                        "order_index": 0,
                        "lessons": [
                            {"title": "Largo y corto", "content": "# 📏 Largo y Corto\n\nComparamos objetos por su longitud: ¿cuál es más largo?\n\n## 📏 Uso la Regla para Medir\n\n:::visual:ruler,0,10,cm,2,7:::\n\nLa zona **amarilla** mide **5 cm** (del 2 al 7).\n\n## 🔍 Comparación de longitudes\n\n:::visual:comparison,3,7,Crayón (3cm),Lápiz (7cm):::\n\nEl **Lápiz** mide **7 cm** y el **Crayón** mide **3 cm**. El lápiz es más largo.\n\n## 📝 Vocabulario\n\n- **Largo** = más centímetros, se extiende más\n- **Corto** = menos centímetros\n- **Alto** = mucha altura (de arriba hacia abajo)\n- **Bajo** = poca altura\n\n:::tryit:Si un lápiz mide 7 cm y un crayón 3 cm, ¿cuál es más largo?|lápiz|7 > 3 → el lápiz es más largo|el lápiz:::", "order_index": 0},
                        ],
                        "exercises": [
                ...
                "units": [
                    {
                        ...
                        "order_index": 0,
                        "lessons": [
                            {"title": "Calcular perímetro", "content": "# 📏 Perímetro\n\nEl **perímetro** es la medida del **contorno** de una figura — la distancia alrededor.\n\n## 📐 Fórmulas\n\n- **Cuadrado:** P = 4 × lado\n- **Rectángulo:** P = 2 × (largo + ancho)\n- **Triángulo:** P = lado₁ + lado₂ + lado₃\n\n## 🎯 Ejemplo: Cuadrado de lado 6 cm\n\n:::visual:array,6,6:::\n\n**Perímetro** = 6 + 6 + 6 + 6 = **24 cm**\n\nO también: P = 4 × 6 = **24 cm**\n\n## 📏 Ejemplo: Rectángulo de 8 cm × 3 cm\n\n**Perímetro** = 2 × (8 + 3) = 2 × 11 = **22 cm**\n\n## 🧠 Recuerda\n\n- **Perímetro** = suma de todos los lados\n- La unidad es de **longitud** (cm, m, km)\n\n:::tryit:Perímetro de un cuadrado de lado 6 cm|24|4 × 6 = 24 cm|24 cm:::\n:::tryit:Perímetro de un rectángulo de 7 cm de largo y 4 cm de ancho|22|2 × (7 + 4) = 22 cm|22 cm:::", "order_index": 0},
                        ],
                        "exercises": [
                ...
                "units": [
                    {
                        ...
                        "order_index": 0,
                        "lessons": [
                            {"title": "El millón", "content": "# 🔢 El Millón\n\n**1,000,000** = un millón (un 1 seguido de **6 ceros**)\n\n## 🔢 Tabla de Valor Posicional\n\n:::visual:placevalue,1234567:::\n\nEl número **1,234,567** se descompone así:\n\n| Posición | Millones | Cien Mil | Diez Mil | Mil | Centenas | Decenas | Unidades |\n|----------|----------|----------|----------|-----|----------|---------|----------|\n| Cifra | 1 | 2 | 3 | 4 | 5 | 6 | 7 |\n| Valor | 1,000,000 | 200,000 | 30,000 | 4,000 | 500 | 60 | 7 |\n\n## 🧠 Números grandes\n\n| Nombre | Cantidad de ceros | Ejemplo |\n|--------|-------------------|---------|\n| Decena | 1 | 10 |\n| Centena | 2 | 100 |\n| Millar (mil) | 3 | 1,000 |\n| Decena de millar | 4 | 10,000 |\n| Centena de millar | 5 | 100,000 |\n| **Millón** | **6** | **1,000,000** |\n\n## 💡 Dato curioso\n\n> Si contaras del 1 al millón, uno por segundo, sin parar... ¡tardarías más de **11 días**!\n\n:::tryit:¿Cuántas decenas de mil hay en 50,000?|5|50,000 ÷ 10,000 = 5|5:::\n:::tryit:¿Cuántos ceros tiene un millón?|6|1,000,000 tiene 6 ceros|6:::", "order_index": 0},
                        ],
                        "exercises": [
                ...
                "units": [
                    {
                        ...
                        "order_index": 0,
                        "lessons": [
                            {"title": "¿Qué es una razón?", "content": "# ⚖️ Razones\n\nLa **razón** expresa una relación entre dos cantidades.\n\n## 📊 Comparación visual\n\nImagina una bolsa con 3 canicas azules y 2 rojas:\n\n:::visual:comparison,2,3,Rojas (2),Azules (3):::\n\nLa razón **azules : rojas** es **3:2** (3 azules por cada 2 rojas).\n\n## 📝 ¿Cómo se escribe una razón?\n\nSe escribe con **dos puntos**:\n- **3:2** se lee \"3 a 2\"\n- Azul : Rojo = 3 : 2\n\n## 🔄 Simplificar razones\n\n**Ejemplo:** Si hay 6 azules y 4 rojos\n\n6:4 → dividimos ambos entre 2 → **3:2**\n\n| Original | Divisor | Simplificada |\n|----------|---------|-------------|\n| 6:4 | ÷2 | 3:2 |\n| 8:12 | ÷4 | 2:3 |\n| 10:5 | ÷5 | 2:1 |\n\n## 🧠 Consejo\n\n> Las razones son como **fracciones** — puedes simplificarlas dividiendo ambos números por el mismo divisor.\n\n:::tryit:Si hay 6 azules y 4 rojos, ¿cuál es la razón simplificada?|3:2|6÷2=3, 4÷2=2|3:2:::", "order_index": 0},
                        ],
                        "exercises": [
                ...
                "units": [
                    {
                        ...
                        "order_index": 0,
                        "lessons": [
                            {"title": "Velocidad constante", "content": "# 🚗 Velocidad\n\nLa **velocidad** nos dice qué tan rápido se mueve algo.\n\n**Velocidad = Distancia ÷ Tiempo**\n\n## 🎯 Ejemplo: 120 km en 2 horas\n\nUn auto recorre 120 km en 2 horas. ¿Cuál es su velocidad?\n\n> 120 km ÷ 2 h = **60 km/h**\n\nEsto significa que cada hora el auto recorre 60 km.\n\n## 📝 Tabla de velocidades\n\n| Distancia | Tiempo | Velocidad |\n|-----------|--------|-----------|\n| 120 km | 2 h | 60 km/h |\n| 150 km | 3 h | 50 km/h |\n| 200 km | 4 h | 50 km/h |\n| 80 km | 1 h | 80 km/h |\n\n## 🧠 Consejo\n\n> **Velocidad constante** = la velocidad no cambia con el tiempo.\n> Si vas a 60 km/h, cada hora recorres 60 km.\n\n:::tryit:Un ciclista recorre 150 km en 3 horas. ¿Cuál es su velocidad?|50|150 ÷ 3 = 50 km/h|150 ÷ 3 = 50 km/h:::\n:::tryit:Un tren a 80 km/h viaja 4 horas. ¿Qué distancia recorre?|320|Distancia = velocidad × tiempo = 80 × 4|80 × 4 = 320 km:::", "order_index": 0},
                        ],
                        "exercises": [
                ...
                "units": [
                    {
                        ...
                        "order_index": 0,
                        "lessons": [
                            {"title": "Relación inversa", "content": "# ⚖️ Proporcionalidad Inversa\n\nCuando **aumenta** una magnitud, la otra **disminuye**.\n\n## 🎯 Ejemplo: Trabajadores y días\n\nSi **3 trabajadores** terminan una obra en **6 días**:\n- Con **6 trabajadores** (el doble), solo necesitan **3 días** (la mitad).\n- Con **9 trabajadores** (el triple), solo necesitan **2 días** (un tercio).\n\nLa cantidad total de trabajo no cambia, solo se reparte entre más personas.\n\n## 📊 Tabla de proporcionalidad inversa\n\n| Trabajadores | Días | Trabajadores × Días |\n|-------------|------|----------------------|\n| 3 | 6 | 18 |\n| 6 | 3 | 18 |\n| 9 | 2 | 18 |\n\nEl producto siempre es el mismo: **18 días-trabajador**.\n\n## 🔑 Fórmula de proporcionalidad inversa\n\n> **Trabajo total = trabajadores × días**\n>\n> Si 4 trabajadores tardan 8 días → trabajo total = 4 × 8 = 32\n>\n> Con 8 trabajadores → 32 ÷ 8 = **4 días**\n\n:::tryit:Si 4 trabajadores hacen una obra en 8 días, ¿en cuántos días la hacen 8 trabajadores?|4|4×8=32, 32÷8=4|4 días:::", "order_index": 0},
                        ],
                        "exercises": [
